description = [{'description': 'Perform Flux Balance Analysis (FBA) on a genome-scale '
  ...
  'optional_parameters': [{'default': None,
                           ...
                           'type': 'dict'},
                          {'default': None,
                           'description': 'Reaction ID to use as the objective '
                                          'function (e.g., biomass reaction)',
  ...
  'required_parameters': [{'default': None,
                           'description': 'Path to the metabolic model file '
                                          '(SBML or JSON format)',
                           'name': 'model_file',
                           'type': 'str'}]},
 {'description': 'Model protein dimerization networks to find equilibrium '
  ...
  'optional_parameters': [],
  'required_parameters': [{'default': None,
                           'description': 'Dictionary mapping monomer names to '
                                          'their initial concentrations (in '
                                          'arbitrary units)',
                           'name': 'monomer_concentrations',
                           'type': 'dict'},
                          {'default': None,
                           'description': 'Dictionary mapping dimer names (as '
                                          "'A-B' strings) to their association "
                                          'constants (Ka)',
                           'name': 'dimerization_affinities',
                           'type': 'dict'},
                          {'default': None,
                           'description': 'List of (monomer1, monomer2) pairs '
 ...
 {'description': 'Construct and simulate kinetic models of metabolic networks '
  ...
  'optional_parameters': [{'default': 100,
                          ...
                          {'default': 1000,
                           ...
                           'type': 'int'}],
  'required_parameters': [{'default': None,
                           'description': 'Path to the COBRA model file (SBML '
                                          'format)',
                           'name': 'model_file',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Dictionary mapping metabolite IDs '
 ...
 {'description': 'Simulate protein signaling network dynamics using ODE-based '
  ...
  'optional_parameters': [{'default': 100,
                           'description': 'Total simulation time in arbitrary '
                                          'time units.',
                           'name': 'simulation_time',
                           'type': 'float'},
                          {'default': 1000,
                           'description': 'Number of time points for the '
                                          'simulation.',
                           'name': 'time_points',
                           'type': 'int'}],
  'required_parameters': [{'default': None,
 ...
 {'description': 'Compares two protein structures to identify structural '
  ...
  'optional_parameters': [{'default': 'A',
                           'description': 'Chain ID to analyze in the first '
                                          'structure',
                           'name': 'chain_id1',
                           'type': 'str'},
                          {'default': 'A',
                           'description': 'Chain ID to analyze in the second '
                                          'structure',
                           'name': 'chain_id2',
                           'type': 'str'},
 ...
 {'description': 'Simulate the time-dependent concentrations of '
  ...
  'required_parameters': [{'default': None,
                          ...
                          {'default': None,
                           ...
                           'type': 'dict'},
                          {'default': None,
                           'description': 'Parameters controlling feedback '
                                          "mechanisms with keys: 'fb_ang_II', "
                                          "'fb_ace2'",
